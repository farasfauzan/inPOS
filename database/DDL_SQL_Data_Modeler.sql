...
COMMENT ON COLUMN users.id IS 'Primary key tabel users';
...
COMMENT ON COLUMN categories.id IS 'Primary key tabel kategori';
...
COMMENT ON COLUMN products.id IS 'Primary key tabel produk';
COMMENT ON COLUMN products.name IS 'Nama produk';
COMMENT ON COLUMN products.category_id IS 'Foreign key ke tabel categories';
...
COMMENT ON COLUMN transactions.user_id IS 'Foreign key ke tabel users (kasir)';
...
COMMENT ON COLUMN transaction_details.id IS 'Primary key detail transaksi';
COMMENT ON COLUMN transaction_details.transaction_id IS 'Foreign key ke tabel transactions';
COMMENT ON COLUMN transaction_details.product_id IS 'Foreign key ke tabel products';
...
COMMENT ON COLUMN stock_history.id IS 'Primary key history';
COMMENT ON COLUMN stock_history.product_id IS 'Foreign key ke tabel products';
...
COMMENT ON COLUMN stock_history.reference_id IS 'ID reference (transaction_id jika sale)';
